	...
	<div class="p-4">
		...
		{#if isEditingDescription}
			<div class="mt-4">
				...
				></textarea>
				<button class="mt-2 px-4 py-2 bg-green-500 text-white rounded" on:click={updateDescription}>
					Save
				</button>
				<button
		...
		{/if}
		<button class="mt-4 px-4 py-2 bg-red-500 text-white rounded" on:click={signOut}>
			Sign Out
		</button>
	</div>
{:else}
