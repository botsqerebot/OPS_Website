...
{:else}
    <div class="w-full min-h-screen px-4 md:px-16 lg:px-32 xl:px-64 py-10 box-border">
        ...
        <!-- Images (placeholder) -->
        <div class="w-full aspect-[16/9] bg-gray-400 flex items-center justify-center rounded-xl mb-8" style="min-height: 300px; max-height: 70vh;">
        ...
        <div class="flex flex-row">
            <div>
                ...
                <div class="mb-2">
                    ...
                    <p class="text-[##262626] opacity-90 text-left whitespace-pre-line">{anonnse.beskrivelse}</p>
                </div>
                <!-- Seperating div -->
                ...
                <div class="text-xs text-[##262626] opacity-60 mt-4 text-left">
                    ...
                    <span class="ml-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="inline w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="##262626"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
